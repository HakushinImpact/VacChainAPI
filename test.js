...
sampleEntry3.health_information.medical_history.disease = [
  'Bronchial Asthma',
  'Hypertension'
];
...
sampleEntry4.health_information.medical_history.disease = [
  'Lung Cancer',
  'Hypertension'
];
...
sampleEntry5.health_information.medical_history.disease = [
  'Lung Cancer',
  'Hypertension'
];
...
sampleEntry6.health_information.medical_history.disease = [
  'Bronchial Asthma',
  'Hypertension'
];
...
sampleEntry7.health_information.medical_history.disease = [
  'Lung Cancer',
  'Hypertension'
];
...
const test = async () => {
  ...
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry3)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry4)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry5)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry6)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry7)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry8)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry9)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  await axios
    .post('http://localhost:5000/insertEntry', sampleEntry10)
    .then(response => {
      console.dir(response.data, { depth: null });
    });
  ...
  await axios.post('http://localhost:5000/getEntries').then(response => {
    console.dir(response.data, { depth: null });
  });
